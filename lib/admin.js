...
const { addYears, warrantySummary } = require('./portal');
...
// (addYears / warrantySummary dùng chung từ lib/portal.js — một nguồn duy nhất)
...
module.exports = {
  isLocalRequest, handleList, handleCreate, handleDelete,
